...
"uyu",
            ...
            String[] phu_am_truoc = {" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g ",
" b d đ h k l m n r s t v x th tr ch kh ph gh nh gi ",
" b d đ h k l m n r s t v x th tr ch kh ph gh nh gi * ",
" b d đ h k l m n r s t v x th tr ch kh ph gh nh ",
" h k l m s t ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n q r s t v x th tr ch kh ph nh gi * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g ",
...
" * ",
" b d đ h k l m n r s t v x th tr ch kh ph gh nh * ",
" b c d đ g h l m n p t v x th tr ch kh ph nh ng * ",
" k p q ngh gh s tr",
...
" b c d đ g h l m n q r s t v x th tr ch kh ph nh gi * ",
" b c d đ g h l m n q r s t v x th tr ch kh ph nh gi ",
" b c d đ g h l m q r t v x th tr ch kh ph nh gi ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n q t v x th ch kh ph nh ",
" b c d đ g h l m n q r s t v x th tr ch kh ph nh gi * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g ",
" b c d đ g h l m n q r s t v x th tr ch kh ph nh gi ",
" h, th, q ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m q s t v x th tr ch kh ph nh * ",
" b d đ h k l m n r s t v x th tr ch kh ph gh nh ",
" * " ,
" b c d đ g h l m n r s t v x th tr ch kh ph nh g * ",
" b c d đ g h l m n r s t v x th tr ch kh ph nh g ",
...
" * "
            ...
            for (j = 0; j < len_nguyen; j++)
            {
                if (String.Compare(nguyen1, nguyen_am[j]) == 0)
                {
                    ...
                    if ((phu_am_truoc[j].Contains(" " + phu1 + " ") == true) && (phu_am_sau[j].Contains(" " + phu2 + " ") == true))
                        return true;
                    else
                        return false;
